...
class TestTokenBudget:
    ...
    def test_custom_allocation(self):
        budget = TokenBudget(
            total_budget=2000, essential=1200, supporting=500, filler=200, reserved=100
        )
...
class TestSearchContradictionDetector:
    """Test SearchContradictionDetector neural module."""

    def setup_method(self):
        self.detector = SearchContradictionDetector(hidden_dim=128)
...
class TestSourceAuthorityClassifier:
    ...
    def test_filter_reliable(self):
        ...
        reliable = SourceAuthorityClassifier.filter_reliable(
            sources, min_tier=SourceTier.TIER3_RELIABLE
        )
